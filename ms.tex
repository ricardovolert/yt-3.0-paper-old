...
\input{sections/answer_testing.tex}

\subsection{Code Review}
\input{sections/code_review.tex}

\subsection{YTEP Process}
\input{sections/ytep_process.tex}
...
\input{sections/decomposition_strategies.tex}

\subsection{Grid Analysis}
\input{sections/grid_analysis.tex}

\subsection{Octree Analysis}
\input{sections/octree_analysis.tex}

\subsection{SPH Analysis}
\input{sections/sph_analysis.tex}

\subsection{Unstructured Mesh Analysis}
\input{sections/unstructured_mesh.tex}

\subsection{Non-Cartesian Coordinates}
\input{sections/noncart_coordinates.tex}
...
\input{sections/pubread_figures.tex}

\subsection{IPython Integration and HTML GUIs}
\input{sections/ipython_html.tex}
